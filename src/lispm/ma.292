...
(DEFUN (DO-SPECBIND MA-ASSEMBLE) (INST) INST
  (PROG (BIT-MASK QV-INDEX SLOTLIST BIT TEM)
    ...
    L	(COND ((NULL SLOTLIST)
	       ...
	       (SETF (MA-INST-OP1 *INST*) QV-INDEX)  ;randomly save it.
	       (COND ((NOT (ZEROP BIT-MASK))
		      ...
		      (MA-EMIT CADR:CONS-IR-OP CADR:CONS-OP-DISPATCH
			       CADR:CONS-IR-DISP-CONST QV-INDEX
	    ...
	    (SETQ *PDL-BUFFER-INDEX* NIL)	;gets clobbered.
	      ...
	      ((AND (LISTP (CAAR SLOTLIST))
	       ...
	       (SETQ TEM (MA-GET-QUOTE-INDEX (CAAR SLOTLIST) T))
	       (COND ((NULL QV-INDEX) (SETQ QV-INDEX TEM)))))
...
(DEFUN MA-GET-QUOTE-INDEX (QUAN &OPTIONAL ALWAYS-ADD)
 `(MCLAP-GET-QUOTE-INDEX ,QUAN ,ALWAYS-ADD))
