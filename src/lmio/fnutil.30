...
(DEFUN FILE-PARSE-NAME (NAMESTRING &OPTIONAL WITH-RESPECT-TO (DEFAULT T) DEFAULT-TYPE)
  (COND ((TYPEP NAMESTRING 'FILENAME) NAMESTRING)
	...
	(T (FERROR NIL "~S is not a valid namestring" NAMESTRING))))
...
(DEFFLAVOR FILENAME (HOST) ()
  ...
  (:INIT-KEYWORDS :NAMESTRING :DEFAULT-FILENAME :DEFAULT-TYPE :SPECIAL-TYPE)
...
(ADD-INITIALIZATION "NEW-FILE-NAME" '(FILE-LOGIN USER-ID) '(ONCE))

