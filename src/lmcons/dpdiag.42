...
(IF-FOR-MACLISP (DEFMACRO LOGAND* (&REST X) `(BOOLE 1 . ,X)))

(IF-FOR-MACLISP (DEFMACRO LOGXOR* (&REST X) `(BOOLE 6 . ,X)))

(IF-FOR-LISPM
(DEFMACRO LOGXOR* (X Y) `(+ (ASH (LOGXOR (LDB 2020 ,X) (LDB 2020 ,Y)) 20)
                              (LOGXOR (LDB 0020 ,X) (LDB 0020 ,Y)))) )
(IF-FOR-LISPM
(DEFMACRO LOGAND* (X Y) `(+ (ASH (LOGAND (LDB 2020 ,X) (LDB 2020 ,Y)) 20)
