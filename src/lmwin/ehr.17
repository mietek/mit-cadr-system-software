...
(DEFPROP FLOATING-EXPONENT-UNDERFLOW FLOATING-EXPONENT-PROCEED PROCEED)
(DEFUN FLOATING-EXPONENT-PROCEED (SG ETE &AUX NUM)
  (DO () (())
...
(DEFPROP FLOATING-EXPONENT-OVERFLOW FLOATING-EXPONENT-PROCEED PROCEED)

;; DIVIDE-BY-ZERO
;; You cannot recover.
