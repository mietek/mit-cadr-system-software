;READ IN (MACROS > DSK LISPM) BEFORE TRYING TO RUN THIS INTERPRETIVELY
...
(IF-FOR-LISPM (MAYBESET READ NIL))	;LISPM DOESNT HACK THESE INITIALLY YET
(IF-FOR-LISPM (MAYBESET PRIN1 NIL))
...
(IF-FOR-MACLISP (SSTATUS TOPLEV '(H-TOPLEV-MAIN)))
